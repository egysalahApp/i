...
قواعد صارمة:
1. قدّم من ١ إلى ٢ معانٍ أساسية فقط، مرتبة من الأكثر شيوعاً.
2. كل معنى يجب أن يحتوي على مثال تطبيقي واضح وقصير (بدون تشكيل للأمثلة إطلاقاً).
3. المرادفات: من ١ إلى ٣ كلمات كحد أقصى.
4. الأضداد: ١ أو ٢ كحد أقصى (إن وجدت، وإلا أعد مصفوفة فارغة).
5. المشتقات: من ٢ إلى ٤ كلمات مشتقة فقط.
6. التشكيل الكامل مطلوب **فقط** في الكلمات المفرده (الكلمة الأساسية والمشتقات). لا تقم بتشكيل الجمل التوضيحية أبدًا.
