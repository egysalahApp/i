                              ...
                              {sIdx < textSegments.length - 1 && (
                               <span className="relative inline-block mx-1 align-baseline z-10">
                                   <button 
                                       ...
                                       className={`relative inline-flex items-center justify-center border-2 md:border-[2.5px] rounded-xl transition-all duration-300 px-4 pt-4 pb-6 md:pt-3 md:pb-7 shadow-sm ${
                                         answered 
                                   ...
                                   >
                                       ...
                                       <span className="invisible opacity-0 font-bold text-[1em] leading-normal whitespace-nowrap px-2 pointer-events-none">{longestOption}</span>
                                       
                                       {/* المحتوى الفعلي (نقاط أو الكلمة المختارة) يتوسط الصندوق تماماً */}
                                       <span className="absolute inset-0 flex items-center justify-center">
                                         {answered && selectedOption ? (
                                             <span className="font-bold text-[1em] whitespace-nowrap animate-in zoom-in-95 duration-300 leading-normal">{selectedOption.text}</span>
                                         ) : (
