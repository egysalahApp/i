    ...
    <div className="max-w-4xl mx-auto fade-in">
      <div className="bg-white border border-slate-200 rounded-[2rem] p-8 md:p-12 shadow-[0_10px_40px_-15px_rgba(0,0,0,0.1)] relative text-center">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-amber-50 text-amber-500 mb-4 shadow-sm border border-amber-100 text-3xl">✨</div>
